...
== Redmine Upgrade
Copy the files directory content into your new installation (this directory contains all your uploaded files fom CKEditor).

    cp -r redmine/public/system/rich new_redmine_folder/public/system/rich
